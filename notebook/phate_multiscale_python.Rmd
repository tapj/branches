...
scprep.plot.scatter2d(hp_embedding, s = sizes_viz, c = cluster_viz,
                      fontsize=7, ticks=False,label_prefix="Multiscale PHATE", figsize=(16,12))
...
coarse_embedding, coarse_clusters, coarse_sizes = mp_op.transform(visualization_level = levels[5],
